        ...
        <div className='single-project'>
            <div className="single-project-img">
                <div className='single-project-img__wrapper'>
                    <Image src={img} alt={name} height='500' width='700' objectFit='contain' />
                </div>
            </div>
            <div className="single-project-details">
                ...
                <div className='project-link'>
                    {/* Github Icon */}
                    <a href={link.github} rel="noreferrer" target='_blank'>
                    ...
                    {/* link Icon */}
                    <a href={link.website} rel="noreferrer" target='_blank'>
